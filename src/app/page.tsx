...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className=" bg-footerBlack  mb-32 grid text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left">
        <a
          ...
          rel="noopener noreferrer"
        >
          <h2 className={`bg-onFace mb-3 text-2xl font-semibold`}>
            Docs{' '}
        ...
        <a
          ...
          rel="noopener noreferrer"
        >
          <h2 className={`mygradiente mb-3 text-2xl font-semibold`}>
            Learn{' '}
            <span className="inline-block transition-transform group-hover:translate-x-1 motion-reduce:transform-none">
              -&gt;
            </span>
        ...
        >
          ...
          <p
            className={` font-tblog m-0 max-w-[30ch] text-balance text-sm opacity-50`}
          >
