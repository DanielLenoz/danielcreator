      ...
      <article className="flex flex-col items-center gap-2 xl:flex-row">
        <section className="grid justify-items-start gap-2">
          ...
          <p className=" font-textPrimary text-base font-normal md:text-lg">
            ...
            <span>investigación exhaustiva.</span> Nos tomamos el tiempo de
            conocer a nuestros clientes,{' '}
            <span>entender sus necesidades y estudiar sus objetivos. </span>{' '}
            ...
            <br />
            Creemos en la <span>negociación justa y transparente.</span> Nuestro
            objetivo es proporcionar un servicio optimizado en los procesos
            clave del producto, permitiéndote ver información relevante sobre el
            mismo.
          </p>
          <button className="inline-block rounded-lg bg-cyan-700 px-2 py-1 font-textSegundary text-base font-medium text-white shadow-lg shadow-gray-500 hover:bg-tertiary hover:shadow-cyan-700 md:text-lg">
            <Link href={''}>Contrato para Landing Pages</Link>
          </button>
          <button className="inline-block rounded-lg bg-cyan-900 px-2 py-1 font-textSegundary text-base font-medium text-white shadow-lg shadow-gray-500 hover:bg-tertiary hover:shadow-cyan-900 md:text-lg">
            <Link href={''}>Contrato para Pagina Web Dinamica</Link>
          </button>
        </section>
        <Image
          className=" rounded-2xl shadow-xl shadow-gray-500"
      ...
      <article className="flex flex-col items-center gap-2 xl:flex-row">
        <section className="grid items-start gap-2">
          ...
          <p className=" font-textPrimary text-base font-normal md:text-lg">
            ...
            <span>confiable para el usuario,</span> siguiendo siempre las
            mejores prácticas. Nuestro objetivo es asegurar que el{' '}
            <span>sitio web sea rápido, seguro y confiable.</span>
            ...
            <span>cumpla con todas las funcionalidades</span> previamente
            definidas.
          </p>
        </section>
        <Image
      ...
      <article className="flex flex-col items-center gap-2 xl:flex-row-reverse">
        <section className="grid items-start gap-2">
          ...
          <p className=" font-textPrimary text-base font-normal  md:text-lg">
            ...
            <span>Mantenemos un seguimiento constante del sitio web</span>{' '}
            durante un período determinado para garantizar su usabilidad y{' '}
            <span>calidad a lo largo del tiempo.</span> <br />
            Dependiendo del sitio web y las condiciones acordadas en las
            negociaciones iniciales,{' '}
            <span>también puedes adquirir el código y el diseño</span> para tu
            propio equipo de desarrollo.
          </p>
        </section>
        <Image
          className=" rounded-2xl shadow-xl shadow-gray-500"
